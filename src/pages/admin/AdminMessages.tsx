...
export default function AdminMessages() {
  ...
  useEffect(() => {
    ...
    load();
    const channel = supabase.channel("messages").on("postgres_changes", { event: "INSERT", schema: "public", table: "messages", filter: `project_id=eq.${selectedProject}` }, () => load()).subscribe();
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 h-[calc(100vh-3rem)] flex flex-col">
      <div>
        ...
        <p className="text-sm text-muted-foreground">Communicate with clients and team</p>
      </div>
